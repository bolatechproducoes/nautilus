...
A estrutura de pastas foi feita com base no último projeto em JavaScript do [Curso de TypeScript e JavaScript](https://www.udemy.com/course/curso-de-javascript-moderno-do-basico-ao-avancado/) do Professor Luiz Otávio Miranda na Udemy. Esse projeto surgiu como um autodesafio de aplicação dos conhecimentos adquiridos durante o curso.
